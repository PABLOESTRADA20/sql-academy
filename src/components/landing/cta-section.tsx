...
export function CTASection() {
  return (
    <section className="px-6 py-20 sm:py-28" aria-labelledby="cta-title">
      <motion.div
      ...
      >
        <div className="absolute top-0 right-0 -z-10 h-48 w-48 translate-x-1/4 -translate-y-1/4 rounded-full bg-primary/[0.06] blur-3xl pointer-events-none" />
        <div className="absolute bottom-0 left-0 -z-10 h-36 w-36 -translate-x-1/4 translate-y-1/4 rounded-full bg-ring/[0.04] blur-3xl pointer-events-none" />

        <div className="inline-flex items-center gap-2 rounded-full border border-border/50 bg-background/50 px-4 py-1.5 text-sm mb-6 backdrop-blur-sm" role="status">
